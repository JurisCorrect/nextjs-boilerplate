  ...
  async function startCheckout(e) {
    ...
    try {
      ...
      const res = await fetch(apiPath, {
        ...
        body: JSON.stringify({
          mode: 'payment',
          submission_id: submissionId,            // 👈 passe l’ID
          customer_email: email.trim(),           // 👈 mail
          success_url: absoluteSuccess,           // 👈 la route API respecte celle-ci
          cancel_url: `${window.location.origin}${cancelUrl}`,
          exerciseKind: payload?.exercise_kind || 'cas-pratique',
        }),
      })
